                ...
                child:Padding(
                  ...
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       children: [
                       Text('${VM!.Groub}' ,style: TextStyle(fontSize: 30,color: Colors.white) ,),
                  ClipRRect(
               ...
               child:   Container(
                   color: Golden,
                    ...
                    child:  RawMaterialButton(
                      ...
                      elevation: 0.0,
                      child:Text('${VM!.ButtonCounter}',style: TextStyle(fontSize: 20,color: Colors.white),),

                        onPressed: (){VM!.Clicked();}
                    ),
                  ),
                  ),
                        Text('${VM!.Counter}',style:TextStyle(fontSize: 30,color: Colors.white)),
